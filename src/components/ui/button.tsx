...
function Button({ class: className, variant, size, ...props }: ButtonProps) {
  const typeValue: ComponentProps<"button">["type"] =
    "button";
  ...
  return <KobalteButton {...mergeProps(defaultProps, props)} />
}
